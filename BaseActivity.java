...
public class BaseActivity extends AppCompatActivity {
    ...
    public static  ArrayList<BaseModel> baseModelList = new ArrayList<BaseModel>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CheckInternet.isNetworkAvailable(BaseActivity.this)) {
            // code here
            new BaseAsyncTask().execute();
        } else {
            // code

            Toast.makeText(BaseActivity.this, " internet is not available now ", Toast.LENGTH_LONG).show();
        }
    }
    private class BaseAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progress = ProgressDialog.show(BaseActivity.this, "Base Life",
        ...
        protected void onPostExecute(String result1) {
            ...
            if(result1.toString().length()>1) {
                ...
                mAdapter = new BaseAdapter(baseModelList,BaseActivity.this);
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
                recyclerView.addItemDecoration(new DividerItemDecoration(BaseActivity.this, DividerItemDecoration.VERTICAL_LIST));
         ...
         //       Toast.makeText(BaseActivity.this, "Try again", Toast.LENGTH_LONG).show();
            }
        }
